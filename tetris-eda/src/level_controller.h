 ...
 *
 * Level controllers inherit this class and emit the changeLevel signal
 * when they wish the change the difficulty level of the game. The
 * Board class is configured with a specific level controller, and
 * will react to the changeLevel signal.
 *
 * At the moment there are two subclasses, LevelControllerEDA and
 * LevelControllerPerformance, each implementing their own algorithm
